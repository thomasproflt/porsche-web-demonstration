...
const Navbar = () => {
    ...
    return (
        <motion.nav
            ...
            initial="hidden"
            animate="visible"
            className="absolute flex flex-row top-0 left-0 w-full z-50 px-8 py-8 text-white text-sm bg-gradient-to-b from-black/100 via-black/60 to-black/0 pointer-events-auto"
        >
            ...
            <div className="hidden md:flex md:flex-row md:justify-between gap-8">
                ...
                <img
                    ...
                    loading="lazy"
                    decoding="async"
                    className="w-50 h-auto overflow-hidden select-none pointer-events-none"
                />
